...
int main(int argc, char** argv) {
    ...
    try {
        ...
        settings.video_source.capture_device_index = -1;  // Default webcam (Doesn't work in WSL, so it's off for now.)
        ...
        // Remove or comment out camera-specific settings since we're using a file
