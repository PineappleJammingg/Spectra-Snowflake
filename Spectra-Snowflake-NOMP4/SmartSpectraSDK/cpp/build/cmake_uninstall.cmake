...
if(NOT EXISTS "/home/laneevanger/Spectra-Snowflake/SmartSpectraSDK/cpp/build/install_manifest.txt")
  message(FATAL_ERROR "Cannot find install manifest: \"/home/laneevanger/Spectra-Snowflake/SmartSpectraSDK/cpp/build/install_manifest.txt\"")
endif()

file(READ "/home/laneevanger/Spectra-Snowflake/SmartSpectraSDK/cpp/build/install_manifest.txt" files)
...
function(remove_empty_directories path)
  ...
  while(IS_DIRECTORY "${path}" AND
          NOT "${parent_path}" STREQUAL "/usr/local" AND
          NOT "${path}" STREQUAL "/usr/local/include" AND
          NOT "${path}" STREQUAL "/usr/local/bin" AND
          NOT "${path}" STREQUAL "/usr/local/lib" AND
          NOT "${path}" STREQUAL "/usr/local/lib/cmake")
